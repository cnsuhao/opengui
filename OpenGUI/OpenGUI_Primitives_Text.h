		...
		*/
		...
		public:
			...
			*/
			...
			void setTextSpacing( float spacing_per_glyph ) {
				mAdvTextSpacing = spacing_per_glyph;
			}
			//! Gets the current spacing between glyphs in pixels
			/*! \remark The value is represented as a float to support fractions of pixels. */
			float getTextSpacing() {
				return mAdvTextSpacing;
			}

			//! Adjusts the spacing between lines in pixels
			/*! \remark The value is represented as a float to support fractions of pixels. */
			void setLineSpacing( float spacing_per_line ) {
				mAdvLineSpacing = spacing_per_line;
			}
			//! Gets the current spacing between glyphs in pixels
			/*! \remark The value is represented as a float to support fractions of pixels. */
			float getLineSpacing() {
				return mAdvLineSpacing;
			}
			...
			void setAutoLineAdvance( bool auto_advance ) {
				mAutoLineFeed = auto_advance;
			}
			//! Returns the current value of the automatic line advance setting.
			bool getAutoLineAdvance() {
