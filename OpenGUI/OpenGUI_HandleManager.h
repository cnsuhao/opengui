...
namespace OpenGUI {
	...
	//! Provides notification service for the creation and destruction of Object based objects
	...
	which are notified about the creation and destruction of Object based class objects. There is no
	...
	*/
	class OPENGUI_API HandleManager {
		friend class Object; // needed to access the protected notification functions
	public:
	...
	protected:
		static void _Object_Created( Object* object );
		static void _Object_Destroyed( Object* object );
	private:
